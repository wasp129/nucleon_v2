...
class Signup extends Component {
    constructor() {
        ...
        this.state = {
            ...
            email: "",
            password: "",
            signupHeadline: "Log in",
            signupMessage: "Fill out your email and password."
        }
        ...
        axios.post('/user/signup', {
            ...
            .then(response => {
                ...
                if (!response.data.error) {
                    ...
                    this.setState({
                        signupHeadline: "Congratulations",
                        signupMessage: "You succesfully signed up for Nucleon. Please sign in to get started."
                    })
                    this.child.method();
                } else {
				...
				<div className="signup">
                    <div className="signup-info">
                        ...
                        <div className="signup-info-inner">
                            ...
                            <button className="signup-info-button">Read more</button>
                            <button className="signup-info-button">Buy the book</button>
                        </div>
                    </div>
					<div className="slide-box-main signup-box">
						...
						<div>
							<div>
								<form autoComplete="off">
									...
									<input className="input-standard" type="text" name="name" value={this.state.name} onChange={this.handleChange}/>
									<br/>
                                    <p className="signup-label">Company</p>
									<input className="input-standard" type="text" name="company" value={this.state.company} onChange={this.handleChange}/>
									<br/>
                                    <p className="signup-label">Country</p>
									<select className="country-select" name="country" onChange={this.handleChange}>
                                ...
                                <div className="go-to-login">
                                    <p>Already a member? <span onClick={this.onClick} className="login-optout">Log in</span></p>
                                </div>
							</div>
						</div>
					</div>
				</div>
                <Login onRef={ref => (this.child = ref)} signupHeadline={this.state.signupHeadline} signupMessage={this.state.signupMessage}/>
            </div>    
		);
	}
}
